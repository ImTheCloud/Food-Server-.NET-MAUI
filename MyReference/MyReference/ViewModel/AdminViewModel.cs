...
public class AdminViewModel : ContentPage
{
    ...
    public string UserAddName
    {
        ...
        set
        {
            if (_useraddName != value) { _useraddName = value; OnPropertyChanged(nameof(UserAddName)); }
        }
    }
    ...
    public string UserAddAccessType
    {
        ...
        set
        {
            if (_userAddAccessType != value) { _userAddAccessType = value; OnPropertyChanged(nameof(UserAddAccessType)); }
        }
    }    
    ...
    public string UserAddPassword
    {
        ...
        set
        {
            if (_userAddPassword != value) { _userAddPassword = value; OnPropertyChanged(nameof(UserAddPassword)); }
        }
    }
